...
<!--                                               @click.prevent="updateEquipement(equipement)" data-toggle="modal"-->
<!--                                               data-target="#venteModal">-->
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cart"
                                       v-model="Facture.cout=Vente.cout+' FCFA'" disabled>
                            </div>
                            <div class="form-group">
