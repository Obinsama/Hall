...
<!-- Mirrored from www.nobleui.com/laravel/template/light/email/compose by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:09:45 GMT -->
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <link media="all" type="text/css" rel="stylesheet" href="../assets/plugins/simplemde/simplemde.min.css">
      ...
      <li class="nav-item active">
        ...
        <div class="collapse show" id="email">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item">
              <a href="compose.html" class="nav-link active">Compose</a>
            </li>
          </ul>
        </div>
      </li>
...
<nav class="settings-sidebar">
          ...
          <div class="col-lg-3 email-aside border-lg-right">
            <div class="aside-content">
              ...
              <div class="aside-nav collapse">
                <ul class="nav">
                  <li><a href="inbox.html"><span class="icon"><i data-feather="inbox"></i></span>Inbox<span class="badge badge-danger-muted text-white font-weight-bold float-right">2</span></a></li>
  ...
  <script src="../assets/plugins/simplemde/simplemde.min.js"></script>
    <!-- end plugin js -->
...
<!-- Mirrored from www.nobleui.com/laravel/template/light/email/compose by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:09:48 GMT -->
</html>