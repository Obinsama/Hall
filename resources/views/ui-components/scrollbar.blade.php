...
<!-- Mirrored from www.nobleui.com/laravel/template/light/ui-components/scrollbar by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:10:00 GMT -->
      ...
      <li class="nav-item active">
        ...
        <div class="collapse show" id="uiComponents">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item">
              <a href="scrollbar.html" class="nav-link active">Scrollbar</a>
            </li>
            <li class="nav-item">
