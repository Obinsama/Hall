...
<!-- Mirrored from www.nobleui.com/laravel/template/light/ui-components/button-group by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:09:55 GMT -->
      ...
      <li class="nav-item active">
        ...
        <div class="collapse show" id="uiComponents">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item">
              <a href="button-group.html" class="nav-link active">Button group</a>
            </li>
            <li class="nav-item">
