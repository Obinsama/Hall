...
<!-- Mirrored from www.nobleui.com/laravel/template/light/ui-components/media-object by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:09:57 GMT -->
      ...
      <li class="nav-item active">
        ...
        <div class="collapse show" id="uiComponents">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item">
              <a href="media-object.html" class="nav-link active">Media object</a>
            </li>
            <li class="nav-item">
