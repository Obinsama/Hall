...
<!-- Mirrored from www.nobleui.com/laravel/template/light/ui-components/scrollspy by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:10:00 GMT -->
      ...
      <li class="nav-item active">
        ...
        <div class="collapse show" id="uiComponents">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item">
              <a href="scrollspy.html" class="nav-link active">Scrollspy</a>
            </li>
            <li class="nav-item">
