...
<!-- Mirrored from www.nobleui.com/laravel/template/light/ui-components/pagination by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:09:58 GMT -->
      ...
      <li class="nav-item active">
        ...
        <div class="collapse show" id="uiComponents">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item">
              <a href="pagination.html" class="nav-link active">Pagination</a>
            </li>
            <li class="nav-item">
