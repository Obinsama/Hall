...
<!-- Mirrored from www.nobleui.com/laravel/template/light/charts/sparkline by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:11:04 GMT -->
      ...
      <li class="nav-item active">
        ...
        <div class="collapse show" id="charts">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item">
              <a href="sparkline.html" class="nav-link active">Sparkline</a>
            </li>
          </ul>
        </div>
      </li>
