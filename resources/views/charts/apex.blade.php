...
<!-- Mirrored from www.nobleui.com/laravel/template/light/charts/apex by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:10:59 GMT -->
    ...
    <ul class="nav">
      ...
      <li class="nav-item active">
        ...
        <div class="collapse show" id="charts">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="apex.html" class="nav-link active">Apex</a>
            </li>
            <li class="nav-item">
