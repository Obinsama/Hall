...
<!-- Mirrored from www.nobleui.com/laravel/template/light/charts/morrisjs by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:11:01 GMT -->
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <!-- end plugin css -->
    ...
    <link media="all" type="text/css" rel="stylesheet" href="../assets/plugins/morrisjs/morris.css">
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" data-toggle="collapse" href="#charts" role="button" aria-expanded="true" aria-controls="charts">
        ...
        <div class="collapse show" id="charts">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="apex.html" class="nav-link ">Apex</a>
            </li>
            <li class="nav-item">
              <a href="chartjs.html" class="nav-link ">ChartJs</a>
            </li>
            <li class="nav-item">
              <a href="flot.html" class="nav-link ">Flot</a>
            </li>
            <li class="nav-item">
              <a href="morrisjs.html" class="nav-link active">MorrisJs</a>
            </li>
            <li class="nav-item">
              <a href="peity.html" class="nav-link ">Peity</a>
            </li>
            <li class="nav-item">
              <a href="sparkline.html" class="nav-link ">Sparkline</a>
            </li>
          </ul>
        </div>
      </li>
...
<!-- Mirrored from www.nobleui.com/laravel/template/light/charts/morrisjs by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:11:03 GMT -->
</html>