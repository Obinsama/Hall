...
<!-- Mirrored from www.nobleui.com/laravel/template/light/charts/chartjs by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:10:59 GMT -->
      ...
      <li class="nav-item active">
        ...
        <div class="collapse show" id="charts">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item">
              <a href="chartjs.html" class="nav-link active">ChartJs</a>
            </li>
            <li class="nav-item">
