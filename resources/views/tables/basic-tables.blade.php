...
<!-- Mirrored from www.nobleui.com/laravel/template/light/tables/basic-tables by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:11:04 GMT -->
    ...
    <ul class="nav">
      ...
      <li class="nav-item active">
        ...
        <div class="collapse show" id="tables">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="basic-tables.html" class="nav-link active">Basic Tables</a>
            </li>
            <li class="nav-item">
