...
<!-- Mirrored from www.nobleui.com/laravel/template/light/tables/data-table by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:11:04 GMT -->
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" data-toggle="collapse" href="#tables" role="button" aria-expanded="true" aria-controls="tables">
        ...
        <div class="collapse show" id="tables">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="basic-tables.html" class="nav-link ">Basic Tables</a>
            </li>
            <li class="nav-item">
              <a href="data-table.html" class="nav-link active">Data Table</a>
            </li>
          </ul>
        </div>
      </li>
...
<!-- Mirrored from www.nobleui.com/laravel/template/light/tables/data-table by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:11:06 GMT -->
</html>