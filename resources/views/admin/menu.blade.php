...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <title>Sylas Admin Dashboard </title>
...
<div class="main-wrapper" id="app">
    ...
    <nav class="sidebar">
        ...
        <div class="sidebar-body">
            <ul class="nav">
                ...
                <li class="nav-item"><a href="{{route('messages.index')}}" class="nav-link">
                        <i class="link-icon" data-feather="mail"></i>
                        <span class="link-title msgSpan">Messages</span>
                    </a>
                </li>
                @can('user-list')
                ...
                <li class="nav-item"><a href="{{route('roles.index')}}" class="nav-link">
                        ...
                        <span class="link-title rolesSpan">Roles</span>
                    </a>
                </li>
                    @endcan
    ...
    <nav class="settings-sidebar">
        <div class="sidebar-body">
            ...
            <button class="btn btn-primary submit"><span  onclick="window.open('http://192.168.1.100:8002/index.php?zone=portail')" style="color:white;">Go to page</span></button>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown nav-messages">
                        ...
                        <div class="dropdown-menu" aria-labelledby="messageDropdown">
                            <div class="dropdown-header d-flex align-items-center justify-content-between">
                                <p class="mb-0 font-weight-medium">{{$msgs->count()}} New Messages</p>
                                <a href="javascript:;" class="text-muted">Clear all</a>
                            </div>
                            <div class="dropdown-body">
                                @foreach($msgs as $msg)
                                <a href="{{route('messages.show',['message'=>$msg->id])}}" class="dropdown-item">
                                    <div class="figure">
                                        <img src="{{asset('assets/images/faces/user2.png')}}" alt="userr">
                                    </div>
                                    <div class="content">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <p>{{$msg->object}}</p>

                                            <p class="sub-text text-muted"> min ago</p>
                                        </div>
                                        <p class="sub-text text-muted">{{$msg->content}}</p>
                                    </div>
                                </a>
                                @endforeach
                    ...
                    <li class="nav-item dropdown nav-profile">
                        <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="{{asset('assets/images/faces/user2.png')}}" alt="profile">
                        </a>
                        <div class="dropdown-menu" aria-labelledby="profileDropdown">
                            <div class="dropdown-header d-flex flex-column align-items-center">
                                <div class="figure mb-3">
                                    <img src="{{asset('assets/images/faces/user2.png')}}" alt="">
                                </div>
