...
@include('admin.menu')
    <div class="page-content acceuil">
                ...
                <div class="card overflow-hidden">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
                            <h6 class="card-title mb-0">Global Usage</h6>
                            <div class="dropdown">
                        ...
                        <div class="row align-items-start mb-2">
                            <div class="col-md-7">
                                <p class="text-muted tx-13 mb-3 mb-md-0">You have ability to control your data usage by checking this chart.</p>
                            </div>
                            <div class="col-md-5 d-flex justify-content-md-end">
                                <div class="btn-group mb-3 mb-md-0 switch_stats" role="group" aria-label="Basic example">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-baseline mb-2">
                            <h6 class="card-title mb-0">Monthly Usage</h6>
                        ...
                        <p class="text-muted mb-4">This is a comparative view of your monthly usage of internet.</p>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-4 mb-3">
                            <div class="col-6 d-flex justify-content-end">
                                <div>
                                    <label class="d-flex align-items-center justify-content-end tx-10 text-uppercase font-weight-medium">Total data <span class="p-1 ml-1 rounded-circle bg-primary-muted"></span></label>
                                    <h5 class="font-weight-bold mb-0 text-right volume">8TB</h5>
                                </div>
                            </div>
                            <div class="col-6">
                                <div>
                                    <label class="d-flex align-items-center tx-10 text-uppercase font-weight-medium"><span class="p-1 mr-1 rounded-circle bg-primary"></span> Used data</label>
                                    <h5 class="font-weight-bold mb-0 used">6TB</h5>
                                </div>
                            </div>
                        </div>
                        <button class="btn btn-primary btn-block" ><a href="{{route('products.index')}}" style="color: white">Buy data</a></button>
                    </div>
                </div>
            </div>
        </div> <!-- row -->
