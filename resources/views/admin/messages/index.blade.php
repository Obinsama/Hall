                        ...
                        <div class="col-lg-3 email-aside border-lg-right">
                            <div class="aside-content">
                                ...
                                <div class="aside-nav collapse">
                                    <ul class="nav">
                                        <li class="active"><a href="#"><span class="icon"><i data-feather="inbox"></i></span>Inbox<span class="badge badge-danger-muted text-white font-weight-bold float-right">{{$unread->count()}}</span></a></li>
                        ...
                        <div class="col-lg-9 email-content">
                            <div class="email-inbox-header">
                                <div class="row align-items-center">
                                    <div class="col-lg-6">
                                        <div class="email-title mb-2 mb-md-0"><span class="icon"><i data-feather="inbox"></i></span> Inbox <span class="new-messages">({{$unread->count()}} new messages)</span> </div>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                @foreach($messages as $message)
                                    @if($message->read==0)
                                        ...
                                        <div class="email-list-item email-list-item--unread">
                                            ...
                                            <a href="{{route('messages.show',['message'=>$message->id])}}" class="email-list-detail">
                                                <div>
                                                    <span class="from">{{$message->object}}</span>
