...
<!-- Mirrored from www.nobleui.com/laravel/template/light/advanced-ui/cropper by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:10:01 GMT -->
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <!-- end plugin css -->
    ...
    <link media="all" type="text/css" rel="stylesheet" href="../assets/plugins/cropperjs/cropper.min.css">
    ...
    <ul class="nav">
      ...
      <li class="nav-item active">
        ...
        <div class="collapse show" id="advanced-ui">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="cropper.html" class="nav-link active">Cropper</a>
            </li>
            <li class="nav-item">
              <a href="owl-carousel.html" class="nav-link ">Owl Carousel</a>
            </li>
            <li class="nav-item">
...
<div class="row">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-8">
            ...
            <div>
              <img src="../assets/images/sample3.jpg" class="w-100" id="croppingImage" alt="cropper">
            </div>
  ...
  <p class="text-muted text-center text-md-left mb-0 d-none d-md-block">Handcrafted With <i class="mb-1 text-primary ml-1 icon-small" data-feather="heart"></i></p>
    ...
    <!-- plugin js -->
      <script src="../assets/plugins/cropperjs/cropper.min.js"></script>
    <!-- end plugin js -->
...
<!-- Mirrored from www.nobleui.com/laravel/template/light/advanced-ui/cropper by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:10:03 GMT -->
</html>