...
<!-- Mirrored from www.nobleui.com/laravel/template/light/advanced-ui/sweet-alert by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:10:39 GMT -->
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <!-- end plugin css -->
    ...
    <link media="all" type="text/css" rel="stylesheet" href="../assets/plugins/sweetalert2/sweetalert2.min.css">
      ...
      <li class="nav-item active">
        ...
        <div class="collapse show" id="advanced-ui">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item">
              <a href="sweet-alert.html" class="nav-link active">Sweet Alert</a>
            </li>
          </ul>
        </div>
      </li>
...
<div class="row">
  ...
  <script src="../assets/plugins/promise-polyfill/polyfill.min.js"></script>
    <!-- end plugin js -->
...
<!-- Mirrored from www.nobleui.com/laravel/template/light/advanced-ui/sweet-alert by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:10:41 GMT -->
</html>