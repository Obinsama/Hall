...
<!-- Mirrored from www.nobleui.com/laravel/template/light/advanced-ui/owl-carousel by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:10:03 GMT -->
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <!-- end plugin css -->
    ...
    <link media="all" type="text/css" rel="stylesheet" href="../assets/plugins/owl-carousel/assets/owl.carousel.min.css">
  <link media="all" type="text/css" rel="stylesheet" href="../assets/plugins/owl-carousel/assets/owl.theme.default.min.css">
  <link media="all" type="text/css" rel="stylesheet" href="../assets/plugins/animate-css/animate.min.css">
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" data-toggle="collapse" href="#advanced-ui" role="button" aria-expanded="true" aria-controls="advanced-ui">
          <i class="link-icon" data-feather="anchor"></i>
          <span class="link-title">Advanced UI</span>
          <i class="link-arrow" data-feather="chevron-down"></i>
        </a>
        <div class="collapse show" id="advanced-ui">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="cropper.html" class="nav-link ">Cropper</a>
            </li>
            <li class="nav-item">
              <a href="owl-carousel.html" class="nav-link active">Owl Carousel</a>
            </li>
            <li class="nav-item">
              <a href="sweet-alert.html" class="nav-link ">Sweet Alert</a>
            </li>
          </ul>
        </div>
      </li>
...
<!-- Mirrored from www.nobleui.com/laravel/template/light/advanced-ui/owl-carousel by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Apr 2020 00:10:39 GMT -->
</html>